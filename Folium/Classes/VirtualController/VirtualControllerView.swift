...
class VirtualControllerView : UIView {
    ...
    init(console: Core.Console, virtualButtonDelegate: VirtualControllerButtonDelegate) {
        ...
        switch console {
        case .n3ds, .nSwitch:
            addDpadUp(false, buttonColor: console.buttonColors()[.dpadUp] ?? .systemGray)
            addDpadLeft(false, buttonColor: console.buttonColors()[.dpadLeft] ?? .systemGray)
            ...
            addY(false, buttonColor: console.buttonColors()[.y] ?? .systemGray)
            
            addMinus(false, buttonColor: console.buttonColors()[.minus] ?? .systemGray)
            addPlus(false, buttonColor: console.buttonColors()[.plus] ?? .systemGray)
            
            addL(false, buttonColor: console.buttonColors()[.l] ?? .systemGray)
            addZL(false, buttonColor: console.buttonColors()[.zl] ?? .systemGray)
            addR(false, buttonColor: console.buttonColors()[.r] ?? .systemGray)
            addZR(false, buttonColor: console.buttonColors()[.zr] ?? .systemGray)
        case .nds:
            addDpadUp(false, buttonColor: console.buttonColors()[.dpadUp] ?? .systemGray)
            addDpadLeft(false, buttonColor: console.buttonColors()[.dpadLeft] ?? .systemGray)
            addDpadDown(false, buttonColor: console.buttonColors()[.dpadDown] ?? .systemGray)
